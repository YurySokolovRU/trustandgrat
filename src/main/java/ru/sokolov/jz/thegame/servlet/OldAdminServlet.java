 ...
 */
@WebServlet(name = "OldAdminServlet", urlPatterns = "/oldadmin")
public class OldAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if ("jz".equals(request.getParameter("pass"))) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("views/oldadmin.jsp");
            requestDispatcher.forward(request, response);
        } else {

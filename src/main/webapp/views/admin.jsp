...
<script>
    function showPlayers() {
        var playersHTML = '';
        <% for (Player player : allPlayers) { %>
            playersHTML += '<span onmouseover=\'this.style.color = "red"\' onmouseout=\'this.style.color = "black"\'><span onclick=\'toRating(this)\'><%=player.getTimestamp()%></span> (<%=player.getUser().getLogin()%>)</span><br>';
        <% } %>

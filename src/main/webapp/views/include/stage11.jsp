...
<div>
    ...
    <br>По сравнению с другими игроками, Вы на <span style="font-weight:bold;"><%=data.getBetsSumRatingPosition(betsSum)%></span> месте (по сумме) и
    <span style="font-weight:bold;"><%=data.getBetsPercentRatingPosition(betsSum)%></span> (по проценту) доверенного.
</div>
<br><br>
<div>
    ...
    <br>По сравнению с другими игроками, вы на <span style="font-weight:bold;"><%=data.getReturnsSumRatingPosition(betsSum)%></span> месте (по сумме) и
    <span style="font-weight:bold;"><%=data.getReturnsPercentRatingPosition(returnsPercent)%></span> (по проценту) возвращенного.
</div>
<br><br>
<div>
    ...
    <br>По сравнению с другими игроками, вы на <span style="font-weight:bold;"><%=data.getResultWalletRatingPosition(player.getStagesResultWallet())%></span> месте
</div>
<br>
<div>

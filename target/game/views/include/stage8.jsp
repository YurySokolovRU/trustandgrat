...
<table>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage8_warning1" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage8_warning2" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage8_warning3" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage8_warning4" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage8_warning5" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage8_warning6" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
</table>
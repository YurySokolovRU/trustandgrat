...
%>
<%--stage3_{n}_after--%>
<div id="<%=step%>_return" class="red">Ваш партнер вернул Вам в качестве благодарности за доверие <span style="font-weight:bold;"><%=PlayServlet.getCreditSpelling(compReturn)%></span></div>
<ul>

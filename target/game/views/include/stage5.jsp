...
<table>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage5_warning1" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage5_warning2" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage5_warning3" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage5_warning4" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage5_warning5" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
    <tr><td colspan="7"><hr/></td></tr>
    ...
    <tr align="center" valign="top">
        <td></td>
        <td colspan="5">
            <div id="stage5_warning6" class="red" style='display:none;'>Сделайте выбор</div>
        </td>
        <td></td>
    </tr>
</table>
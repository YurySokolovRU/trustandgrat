...
<input style="width: 100px" type="number" name="<%=step%>_bet" min="0" max="<%=player.getStage3Wallet()%>" step="1" required autofocus="true">
<span id="<%=step%>_pause" class="red" style="display:none;">Ваш партнер принимает решение...</span>
<br>